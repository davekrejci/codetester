      ...
      <v-list-item>
        <v-list-item-content>
          ...
          <v-card flat color="transparent" justify="center" align="center">
            <v-chip-group mandatory active-class="primary--text" column>
              <v-chip
        ...
        <v-card :key="`question-${question.number}`" :id="`question-${question.number}`" class="ma-0 pa-4" color="transparent" flat>
          <v-list-item three-line>
            <v-list-item-content>
              ...
              <fill-blank-code-editor v-if="question.type == 'fill-in-code'" :content="question.answers"></fill-blank-code-editor>
              
              <!-- <v-checkbox v-if="question.type == 'multiple-choice'" v-for="answer in question.answers" :key="answer.id"></v-checkbox> -->
  ...
  >
    <v-list dense class="pa-0" color="transparent">
      ...
      >
        ...
        <v-divider class="primary--text" :key="`question-divider-${question.number}`"></v-divider>
  </template>
...
export default {
  ...
  data() {
    ...
    drawer: true,
      questions: [
        { number: 1, type: "multi-choice", question: "Co je to třída?", answers: [{id:"9821390", text:"Předpis, který definuje strukturu objektu."},{id:"2981312", text:"Skupina, která obsahuje různorodé typy objektů."},{id:"87126312", text:"Reálná věc."},{id:"982173721", text:"Reprezentace konkrétní věci reálného světa."}] },
        { number: 2, type: "multi-choice", question: "Kdy je vykonána první část hlavičky cyklu for?", answers: [{id:"9221390", text:"Při vstupu do cyklu."},{id:"2991312", text:"Před každým průběhem cyklu."},{id:"87126352", text:"Pouze po prvním průběhu cyklu."},{id:"982173021", text:"Po každém průběhu cyklu."},{id:"982143821", text:"Pouze po posledním průběhu cyklu."}] },
        { number: 3, type: "fill-in-code", question: "Doplnte kod", answers: `public boolean addPerson(Person personToAdd){\n\tif(personToAdd == null) return false;\n\tfor (int i = 0; i < persons.length; i++){\n\t\tif({"widget_id":"98231", "length":16}){\n\t\tpersons[i] = personToAdd;\n\t\treturn true;\n\t\t}\n\t}\n\treturn false;\n}` },
